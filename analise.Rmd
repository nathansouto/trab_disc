...
fit = rpart(formula = dados$Attrition ~ ., method = 'class', data = dados, parms = list(split = 'information'), cp = 0.01) #, control = repart.control(minsplit = 1, minbucket = 1, maxdepth = 25)
